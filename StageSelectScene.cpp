...
void StageSelectScene::Initialize() {
    ...
    ////
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", w - 300, h - 200, 400, 100);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::BackOnClick, this, 2));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Setting", "pirulen.ttf", 42, w-150, h-150 , 0, 0, 0, 255, 0.5, 0.5));
